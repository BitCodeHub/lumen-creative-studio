                ...
                <div ref={floatArPanelRef} style={{ position: "relative" }}>
                  <button
                    ...
                    style={{
                      display: "flex", alignItems: "center", gap: 5, padding: "5px 10px",
                      borderRadius: 20,
                      border: floatArPanelOpen ? "1px solid #4d9fff" : "1px solid #2a2a2a",
                      background: floatArPanelOpen ? "rgba(77,159,255,0.08)" : "#1e1e22",
                      fontSize: 12, color: floatArPanelOpen ? "#4d9fff" : "#bbb", cursor: "pointer",
                    }}>
                    <div style={{
                      width: ASPECT_RATIOS[selectedAR].w > ASPECT_RATIOS[selectedAR].h ? 13 : 9,
                      height: ASPECT_RATIOS[selectedAR].w > ASPECT_RATIOS[selectedAR].h ? 9 : 13,
